...
// ============================================================
// 4. CONDITIONAL FONT ENQUEUE (Fixed Extension Targets)
// ============================================================
...
function dalenii_conditional_fonts() {
    ...
    if ($template === 'single-book-wwii.html') {
        wp_enqueue_style(
            'dalenii-fonts-wwii',
    ...
    if ($template === 'single-book-spy.html') {
        wp_enqueue_style(
            'dalenii-fonts-spy',
...
function dalenii_soe_nav_accent() {
    echo '<style>
    .wp-block-navigation a[href*="soe-fiction-series"] { color: #C8A96A !important; }
    .wp-block-navigation a[href*="soe-fiction-series"]:hover { color: #FAF8F4 !important; }
    </style>' . "\n";
}
